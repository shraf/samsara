 ...
 * @author eldee
 */
public enum City {cairo("القاهرة"),giza("الجيزة"),qalyobia("القليوبية"),alexandria("اسكندرية"),behira("البحيرة"),matrouh("مطروح"),dumiat("دمياط"),daqahlia("دقهلية"),kafr_elsheikh("كفر الشيخ"),elgharbia("الغربية")
